...
require_once dirname( __FILE__ ) . '/modules/admin/class-mm-wpcf7-admin.php';
...
if ( ! class_exists( 'mm_wpcf7\MM_WPCF7_Extension_Plugin' ) ) {
	/**
	...
	class MM_WPCF7_Extension_Plugin {
		...
		public function __construct() {
			add_action( 'update_option_active_plugins', 'mm_wpcf7\MM_WPCF7_Extension_Plugin::check_required_plugins_silent' );
...
register_activation_hook( __FILE__, 'mm_wpcf7\MM_WPCF7_Extension_Plugin::check_required_plugins' );
